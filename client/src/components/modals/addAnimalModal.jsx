...
export default function AddAnimalModal({ open, setOpen, setAnimals, allAnimals }) {
    ...
    const handleAddAnimal = async () => {
        ...
        if (newAnimal) {
            ...
            setAnimals([...allAnimals , newAnimal]);
        } else {
                    ...
                    >
                        <div className="relative transform w-[45%] py-4 overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-md sm:p-6">
                            <div className="flex flex-col gap-5 items-center">
                                <h3 className="text-2xl font-bold leading-6 text-gray-900">Add New Animal</h3>
                            </div>
                            <div className="flex flex-col gap-8 min-h-[300px] w-full max-w-sm mx-auto bg-white rounded-lg">
                                <div className="mt-4 justify-center flex flex-col gap-0">
                                    ...
                                    <div className="mb-2">
                                        <label htmlFor="species" className="block text-gray-700 text-sm">Species</label>
                                        <input
                                            type="text"
                                            id="species"
                                            name="species"
                                    ...
                                    <div className="mb-2">
                                        <label htmlFor="habitat" className="block text-gray-700 text-sm">Habitat</label>
                                        <input
                                            type="text"
                                            id="habitat"
                                            name="habitat"
                                    ...
                                    <div className="mb-2">
                                        <label htmlFor="lifespan" className="block text-gray-700 text-sm">Lifespan</label>
                                        <input
                                            type="text"
                                            id="lifespan"
                                            name="lifespan"
